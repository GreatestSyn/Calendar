...
export const MonthlyCalendarBroadcastModal: React.FC<MonthlyCalendarBroadcastModalProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div className="p-5 border-b border-slate-200 bg-gradient-to-r from-indigo-50 via-sky-50 to-white flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-indigo-600 text-white flex items-center justify-center shadow-xs">
              <Calendar className="w-5 h-5" />
            </div>
            <div>
              <h2 id="monthly-export-title" className="text-base font-bold text-slate-900 leading-tight">
        ...
        <div className="flex-1 overflow-y-auto p-5 sm:p-6 space-y-5 text-xs">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 bg-slate-50 border border-slate-200 rounded-xl">
            <div>
              <span className="text-[11px] font-semibold text-slate-500 uppercase tracking-wider">Target Schedule Period</span>
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-2.5 py-1.5 bg-white hover:bg-slate-100 border border-slate-200 rounded-lg text-slate-700 font-semibold transition-colors"
              >
                &larr; Prev Month
              </button>
              <button
          ...
          {Object.keys(categorySummary).length > 0 && (
            <div className="flex items-center gap-2 flex-wrap">
              <span className="text-slate-500 text-[11px] font-medium">Included categories:</span>
          ...
          <div className="border border-slate-200 rounded-xl p-4 bg-white space-y-3">
            <div className="flex items-center justify-between flex-wrap gap-2">
              <div className="flex items-center gap-2">
                ...
                <h4 className="font-bold text-slate-900">Calendar Image Export (.PNG)</h4>
              </div>
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1 bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold rounded-lg border border-slate-200 transition-colors"
                >
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-3 py-1 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 font-bold rounded-lg border border-indigo-200 transition-colors"
                >
            ...
            {previewImage ? (
              <div className="border border-slate-200 rounded-lg overflow-hidden bg-slate-950/5 p-2">
                ...
                <img
                  ...
                  className="w-full max-h-56 object-contain rounded border border-slate-300 bg-white shadow-xs"
                />
              </div>
            ) : (
              <div className="p-4 rounded-lg bg-slate-50 border border-dashed border-slate-200 text-center text-slate-500">
                <p className="font-medium text-xs">No image rendered yet.</p>
          ...
          <div className="border border-slate-200 rounded-xl p-4 bg-white space-y-3.5">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h4 className="font-bold text-slate-900">Separate Events Chat Broadcast</h4>
              </div>
              ...
              {configuredEventsChat ? (
                ...
                <button
                  ...
                  className="text-[11px] font-bold text-amber-700 bg-amber-50 hover:bg-amber-100 px-2 py-0.5 rounded border border-amber-200 transition-colors inline-flex items-center gap-1"
                >
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3 py-2 bg-slate-50 border border-slate-300 rounded-lg text-xs focus:ring-2 focus:ring-indigo-500 focus:outline-none"
              />
            </div>
        ...
        <div className="p-4 bg-slate-50 border-t border-slate-200 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3 py-1.5 text-xs font-semibold text-slate-700 hover:text-slate-900 bg-white border border-slate-300 rounded-lg shadow-2xs transition-colors inline-flex items-center gap-1.5"
            >
